...
public class Controls {
  ...
  private void positionX(int y, GridBagLayout layout) {
    ...
    c.gridx = 1;
    c.gridwidth = 3;
    var slider = new JSlider(-200, 400, (int) cube.getPosition().x());
  ...
  private void positionY(int y, GridBagLayout layout) {
    ...
    c.gridx = 1;
    c.gridwidth = 3;
    var slider = new JSlider(-200, 400, (int) cube.getPosition().y());
  ...
  private void positionZ(int y, GridBagLayout layout) {
    ...
    c.gridx = 1;
    c.gridwidth = 3;
    var slider = new JSlider(-200, 400, (int) cube.getPosition().z());
    slider.addChangeListener(e -> cube.setPositionZ(((JSlider) e.getSource()).getValue()));
    layout.setConstraints(slider, c);
    this.jPanel.add(slider);
  }
